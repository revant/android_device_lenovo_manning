...
git apply -v ../../device/lenovo/manning/patches_mtk/hardware/interfaces/hardware_interfaces.patch
cd ../..
cd system/core
git apply -v ../../device/lenovo/manning/patches_mtk/system/core/system_core.patch
cd ../..
cd system/sepolicy
git apply -v ../../device/lenovo/manning/patches_mtk/system/sepolicy/system_sepolicy.patch
cd ../..
